...
export class UserService {
  constructor(
    ...
    async updateUsername(user_id: number, user_name_new: string){
        let newcat4 = await this.userModel.findOneAndUpdate({ user_id: user_id }, { user_name: user_name_new } );
      ...
      async updateFullname(user_id: number, full_name_new: string){
        ...
        let newcat4 = await this.userModel.findOneAndUpdate({ user_id: user_id }, { full_name: full_name_new } );
      ...
      async updatePhoneNumber(user_id: number, phone_number_new: string){
        let newcat4 = await this.userModel.findOneAndUpdate({ user_id: user_id }, { phone_number: phone_number_new } );
      ...
      async updateBirth(user_id: number, birth_new: Date){
        let newcat4 = await this.userModel.findOneAndUpdate({ user_id: user_id }, { birth: birth_new } );
      ...
      async updateGender(user_id: number, gender_new: string){
        let newcat4 = await this.userModel.findOneAndUpdate({ user_id: user_id }, { gender: gender_new } );
      ...
      async updateNickName(user_id: number, nick_name_new: string){
        let newcat4 = await this.userModel.findOneAndUpdate({ user_id: user_id }, { nick_name: nick_name_new } );
      ...
      async updateAvatar(user_id: number, avatar_new: string){
        let newcat4 = await this.userModel.findOneAndUpdate({ user_id: user_id }, { avatar: avatar_new } );
      ...
      async updatePassword(user_id: number, password: string, password_new: string) {
        var k = await this.userModel.findOne({user_id: user_id});
        ...
        if(isMatch == true){
          ...
          let newcat4 = await this.userModel.findOneAndUpdate({ user_id: user_id }, { password: hashed_pass } );
