...
export class validateGender {
  ...
  //user_name: string, password: string, full_name: string, phone_number: string, birth: string, gender: string, nick_name: string, avatar: string, wallet_money: string, role: string, image: string, user_id: number