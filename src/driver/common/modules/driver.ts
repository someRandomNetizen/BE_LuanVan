...
import { AuthModule2 } from '../../auth/auth2.module';
import { UsersModule2 } from '../users2/users2.module';
...
@Module({
  imports: [MongooseModule.forFeature([{name: address.name, schema: addressSchema }]),
            ...
            AuthModule2, UsersModule2],

  controllers: [addressController, adsController, brandAdsController, coordController, customerController,
               driverDistanceController, driverController, packageTypesController, packageWeightController,
  ...
  providers: [AddressService, AdsService, BrandAdsService, CoordService, CustomerService,
              DriverDistanceService, DriverService, PackageTypesService, PackageWeightService,
